...
public class EsService {
    ...
    public int addCommodity(OnlineShoppingCommodity commodity) throws IOException {
        ...
        boolean isExist;
        isExist = restHighLevelClient.indices().exists(getIndexRequest,
        ...
        if (!isExist) {
            ...
            builder.startObject()
                    ...
                    .endObject()
                    .endObject();
            CreateIndexRequest request = new CreateIndexRequest(COMMODITY_INDEX);
        ...
        IndexRequest indexRequest = new IndexRequest(COMMODITY_INDEX).source(jsonDoc,
                XContentType.JSON);
    ...
    public List<OnlineShoppingCommodity> searchCommodity(String keyWord, int from, int size) {
        ...
        MultiMatchQueryBuilder multiMatchQueryBuilder =
                multiMatchQuery(keyWord, "commodityName", "commodityDesc");
        ...
        try {
            ...
            for (SearchHit hit: hits1) {
                ...
                OnlineShoppingCommodity commodity = JSON.parseObject(sourceString,
                        OnlineShoppingCommodity.class);
